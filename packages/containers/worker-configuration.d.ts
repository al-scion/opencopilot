/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1336af2f1a69c1bfdd146295e3883523)
// Runtime types generated with workerd@1.20260114.0 2025-12-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OpencodeContainer";
	}
	interface Env {
		OPENAI_API_KEY: string;
		ANTHROPIC_API_KEY: string;
		OpencodeContainer: DurableObjectNamespace<import("./src/index").OpencodeContainer>;
	}
}
